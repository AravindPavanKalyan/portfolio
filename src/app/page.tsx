'use client';
import { FaReact, FaHtml5, FaCss3Alt, FaNodeJs, FaJsSquare, FaCogs, FaGithub } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              { name: "Git", icon: <FaGitAlt className="text-5xl" />, color: "from-orange-500 to-red-600", hoverColor: "from-orange-400 to-red-500" },
              ...
              { name: "C++", icon: <FaCogs className="text-5xl" />, color: "from-blue-400 to-indigo-500", hoverColor: "from-blue-300 to-indigo-400" },
            ].map((skill, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                ...
                image: "/Astro_pong.png",
                tech: ["Next.js", "Django", "TailwindCSS"],
                githubLink: "https://github.com/abizyane/ft_transcendence",
                featured: true
              },
              { 
                title: "Todo App", 
                description: "A modern, responsive Todo application built with Next.js, React, Redux, and TypeScript. Features CRUD operations, sorting, dark/light theme, form validation, user authentication, and persistent storage.", 
                image: "/todo_App.png",
                tech: ["Next.js", "React", "Redux", "TypeScript", "Jest"],
                githubLink: "https://github.com/ahallali/-ToDoApp-",
                featured: true
              },
              { 
                title: "Inception", 
                ...
                image: "/inception.jpg",
                tech: ["Docker", "WordPress", "NGINX", "MariaDB"],
                githubLink: "https://github.com/ahallali/inception"
              },
              { 
                title: "IRC Server", 
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">ahmedallali1@outlook.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">ahmed-allali</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">ahmedallali</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center lg:flex-row lg:justify-between lg:items-center space-y-6 lg:space-y-0">
            ...
            >
              ...
              <motion.a 
                href="https://www.linkedin.com/in/ahmedallali/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="group relative"
                whileHover={{ scale: 1.2, y: -2 }}
              ...
              <motion.a 
                href="mailto:ahmedallali1@outlook.com" 
                className="group relative"
                whileHover={{ scale: 1.2, y: -2 }}
                whileTap={{ scale: 0.9 }}
              >
